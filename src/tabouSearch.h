...
class TabouSearch {
    ...
    int **tNewConflitsWithColor; // contient pour chaque noeud ne nb de conflis en plus ou
                                 // moins si changement vers chaque couleur, suivi de la
                                 // meilleure couleur et meilleur gain associé
    int **tTabou; // contient pour chaque noeud et chaque couleur la fin de la période
                  // taboue

    // optimisation1 permettant de connaitre la meilleure amélioration possible pour
    // chaque noeud
    int *tBestImprove; // contient pour chaque sommet la meilleure valeur de transition
    int **ttBestImproveColor; // contient pour chaque sommet la meilleure transition de
                              // couleur (-1 si plusieurs equivalentes => stratégie
                              // classique)
    int *tNbBestImprove; // contient le nombre pour chaque sommet de couleurs fournissant
